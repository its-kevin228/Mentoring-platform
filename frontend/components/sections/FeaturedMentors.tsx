            ...
            <div className="container mx-auto px-4 md:px-8">
                <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                    <div className="max-w-xl space-y-4">
                        <h2 className="text-4xl font-bold tracking-tight italic text-blue-500">Mentors inspirants</h2>
                        <p className="text-base-content/70">Échangez avec des étudiants expérimentés des meilleures universités, prêts à vous guider dans votre parcours.</p>
                    </div>
                    <button className="btn btn-outline btn-primary rounded-full px-8">Explorer tous les profils</button>
                </div>
